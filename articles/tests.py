...
class ArticleViewSetTest(TestCase):
    ...
    def setUp(self):
        ...
        self.other_article.tags.add("TO")
    ...
    def test_get_article(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(response.data, {"article": self.article_out})
        self._valid_timestamps_in_output_dict(response.data["article"])
...
class TagViewSet(TestCase):
    ...
    def test_list_tags(self):
        ...
        data = loads(response.content, 200)
        self.assertEquals(data, {"tags": mock.ANY})
